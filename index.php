...
<head>
    ...
    <body>
        ...
        <div class="card mx-auto  mt-5" style="width:90%;">
          <div class="card-header ">CRUD Data Nilai</div>
          <div class="card-body">
            ...
            <div class=" mt-3" >
              <!-- judul -->
                <!-- end judul -->
                <!-- Button add nilai -->
                <a href="tambah_nilai.php" class="btn btn-dark mb-2">Tambah</a>
                <!-- Table Data nilai -->
                    ...
                    <tbody>
                        ...
                        <tr  >
                            ...
                            <td>
                              ...
                              echo "<a href= 'update_nilai.php?nim=$nim' class='btn btn-warning  btn-sm' > Update </a>";
                              ?>
